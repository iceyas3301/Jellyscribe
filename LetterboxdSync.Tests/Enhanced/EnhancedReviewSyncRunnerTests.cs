...
{
    private const string UserN = "18dbb05b2e3043a6974216fad9a96c0c";
    private const string OtherUserN = "02ea5b9749ab4232961d060c581a0bcc";
    ...
    {
        AddLetterboxdAccount(UserN, "ivenlb");
        ...
        Assert.Equal(new[] { "ivenlb" }, _letterboxdLogins);
    }
    ...
    {
        AddLetterboxdAccount("18dbb05b-2e30-43a6-9742-16fad9a96c0c", "ivenlb");
        WriteStore(Entry($"{UserN}:movie:278", UserN, "278", "movie", "", 5, "2026-07-16T01:50:06.0000000Z"));
    ...
    {
        AddLetterboxdAccount(UserN, "ivenlb", enabled: false);
        WriteStore(Entry($"{UserN}:movie:278", UserN, "278", "movie", "", 5, "2026-07-16T01:50:06.0000000Z"));
